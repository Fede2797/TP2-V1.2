...
namespace UI.Desktop
{
    public partial class ReportePlanes : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'tp2_netDataSet1.planesJoined' table. You can move, or remove it, as needed.
            this.planesJoinedTableAdapter.Fill(this.tp2_netDataSet1.planesJoined);
